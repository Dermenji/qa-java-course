...
public class Main {
    ...
    //1
        ...
        apartment.location = "Iztok";
        apartment.price = 150000.0;

        log.info(apartment.location);
     ...
     //2
        ...
        House house1 = new House("Sea Garden", 250000,
                Town.BURGAS, 2020, 200,
                new int[]{1, 2, 3}, owner1, true, 50);
        House house2 = new House("Sea Garden", 250000,
                Town.BURGAS, 2020, 200,
                new int[]{1, 2, 3, 4}, owner1, true, 50);
